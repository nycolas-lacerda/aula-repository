                    ...
                    <div class="ms-auto d-flex flex-column flex-lg-row align-items-lg-center gap-3 mt-3 mt-lg-0">
                        @auth
                            <div class="text-white small text-lg-end">
                                ...
                                <div class="opacity-75">{{ \App\Models\User::roleDisplayName($user->getRoleNames()->first() ?? '') }}</div>
                            </div>
                        ...
                        <div class="p-3">
                            <div class="card border-0 shadow-sm mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="fw-semibold">{{ $user->name }}</div>
                                    <div class="text-muted small">{{ \App\Models\User::roleDisplayName($user->getRoleNames()->first() ?? '') }}</div>
                                </div>
                            </div>
