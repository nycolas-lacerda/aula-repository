        ...
        <div class="min-vh-100 d-flex align-items-center py-5">
            <div class="container">
                <div class="row g-0 shadow-lg rounded-4 overflow-hidden bg-white">
                    <div class="col-lg-6 d-flex flex-column justify-content-between p-5 text-white" style="background: linear-gradient(135deg, #0f172a 0%, #1d4ed8 50%, #06b6d4 100%);">
                        <div>
                            <span class="badge text-bg-light text-primary-emphasis fw-semibold mb-3">Sistema pedagógico</span>
                            <h1 class="display-6 fw-bold mb-3">{{ config('app.name', 'Aula') }}</h1>
                            <p class="lead mb-0">
                                Gestão de aulas, atividades, revisões e perfis em uma interface clara, organizada e pronta para apresentação.
                            </p>
                        </div>
